...
class DracheshopScraper(BaseScraper):
    ...
    def base_url(self) -> str:
        return "https://drache-shop.com/shop/page/{num}/?per_page=24&s={query}&post_type=product&type_aws=true"
    async def scrape(self, product_name: str) -> list[ProductResult]:
        ...
        for page_num in count(1):
            ...
            print(f'im in drache-shop page {page_num}', len(products))
            ...
            for product in products:
                ...
                img_url = img_tag["data-src"] if img_tag and img_tag.has_attr("data-src") else "N/A"
